...
url_dict = {}
url_dict['行业规定'] = 'https://lawnew.cnki.net/kns/brief/brief.aspx?dbprefix=CLKLK&queryID=56&clusField=%E6%95%88%E5%8A%9B%E7%BA%A7%E5%88%AB%E4%BB%A3%E7%A0%81&clusCode=09&Param=&t=1621862235934'
headers1 = {
...
res = requests.get(url_dict['行业规定'],headers=headers1).text
print(res)
e = etree.HTML(res)
